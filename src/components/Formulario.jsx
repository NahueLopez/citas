...
export default function Formulario({pacientes,setPacientes,paciente,setPaciente}){
    //Siempre el State tiene que ser dentro del componente pero fuera del return
    ...
    const handleSubmit = (e) =>{
        ...
        if([nombre,propietario,email,fecha,sintomas].includes('')){
            ...
            if(paciente.id){
                ...
                //Nuevo registro
                //Creamos un id para el nuevo registro
                ObjetoPaciente.id = generarID()
                //Creamos una copia del arreglo y lo guardamos
    ...
    return(
        <div className="md:w-1/2 lg:w-2/5 mx-5">
            ...
            <form 
                onSubmit={handleSubmit} //se le pone handleSubmit como buena practica
